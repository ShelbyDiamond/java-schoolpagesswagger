...
public class StudentController {
    ...
    @ApiOperation(value = "Retrieves all of the students without Paging ")
    ...
    @ApiOperation(value = "Retrieves a student associated with the student ID",
    ...
    public ResponseEntity<?> deleteStudentById(
            @ApiParam(value = "The students ID",
                    required = true,
                    example = "42")
            @PathVariable
                    long Studentid) {
